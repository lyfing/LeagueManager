...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ( player ) {
        [cell.textLabel setText:[NSString stringWithFormat:@"%@ %@",[player valueForKey:kPlayerFirstName],[player valueForKey:kPlayerLastName]]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ( indexPath.row < [players count] ) {
        ...
        LMPlayerViewController *playerVC = [[LMPlayerViewController alloc] initWithPlayer:player andTeam:self.team];
...
{
    LMPlayerViewController *playerVC = [[LMPlayerViewController alloc] initWithPlayer:nil andTeam:self.team];
    playerVC.viewControllerStyle = LMViewControllerStyleAdd;
    [self.navigationController pushViewController:playerVC animated:YES];
}
